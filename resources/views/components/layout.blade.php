    ...
    <style>
        ...
        *::after {
        ...
        .sidebar-nav .submenu li a {
            ...
            font-size: 0.9rem;
            border-left: none;
            /* Submenu items don't need the main border */
        }
        ...
        header.main-header {
            ...
            background-color: var(--bg-card);
            box-shadow: 0 1px 3px rgba(0, 0, 0, .02), 0 2px 8px rgba(0, 0, 0, .04);
            display: flex;
            justify-content: space-between;
            align-items: center;
            padding: 0 2.5rem;
        ...
        .dropdown-panel {
            ...
            transition: opacity .2s ease, transform .2s ease, visibility 0s .2s ease;
            z-index: 1000;
            border: 1px solid var(--border-color)
        }
        ...
        .dropdown-panel.show {
            ...
            transition: opacity .2s ease, transform .2s ease, visibility 0s 0s ease
        }
        ...
        .stat-card.green {
            border-bottom-color: var(--success-icon)
        }
        ...
        .stat-card.red {
            border-bottom-color: var(--danger-icon)
        }
        ...
        .profile-menu li a i,
        .profile-menu li .logout-link i {
            margin-right: 8px;
            /* ✅ نفس المسافة بين الأيقونة والنص */
        }

        .profile-menu li .logout-link:hover,
        .profile-menu li a:hover {
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            <button class="sidebar-close" id="sidebarClose" aria-label="Close Sidebar"><i
                    class="fas fa-times"></i></button>
        </div>
        <ul class="sidebar-nav">
            <li class="nav-item">
                <a href="/" class="nav-link {{ Request::is('/') ? 'active' : '' }}"><i
                        class="fas fa-tachometer-alt"></i><span>Dashboard</span></a>
            </li>
            <li class="nav-item">
                <a href="#" class="nav-link model-toggle"><i class="fas fa-cube"></i><span>Model</span><i
                        class="fas fa-chevron-down"></i></a>
                <ul class="submenu" id="modelSubmenu">
                    <li><a href="/leads" class="{{ Request::is('leads') ? 'active' : '' }}"><i
                                class="fas fa-user-plus"></i><span>Leads</span></a></li>
                    <li><a href="/contacts" class="{{ Request::is('contacts') ? 'active' : '' }}"><i
                                class="fas fa-address-book"></i><span>Contacts</span></a></li>
                    <li><a href="/deals" class="{{ Request::is('deals') ? 'active' : '' }}"><i
                                class="fas fa-handshake"></i><span>Deals</span></a></li>
                    <li><a href="/calls" class="{{ Request::is('calls') ? 'active' : '' }}"><i
                                class="fas fa-phone"></i><span>Calls</span></a></li>
                    <li><a href="/tasks" class="{{ Request::is('tasks') ? 'active' : '' }}"><i
                                class="fas fa-tasks"></i><span>Tasks</span></a></li>
                    <li><a href="/meetings" class="{{ Request::is('meetings') ? 'active' : '' }}"><i
                                class="fas fa-calendar-alt"></i><span>Meetings</span></a></li>
                </ul>
            </li>
            <li class="nav-item">
                <a href="/campaigns" class="nav-link {{ Request::is('campaigns') ? 'active' : '' }}"><i
                        class="fas fa-bullhorn"></i><span>Campaigns</span></a>
            </li>
            <li class="nav-item">
                <a href="/projects" class="nav-link {{ Request::is('projects') ? 'active' : '' }}"><i
                        class="fas fa-project-diagram"></i><span>Projects</span></a>
            </li>
            <li class="nav-item">
                <a href="/accounts" class="nav-link {{ Request::is('accounts') ? 'active' : '' }}"><i
                        class="fas fa-building"></i><span>Accounts</span></a>
            </li>
            <li class="nav-item">
                <a href="/documents" class="nav-link {{ Request::is('documents') ? 'active' : '' }}"><i
                        class="fas fa-file-alt"></i><span>Documents</span></a>
            </li>
        </ul>
    </aside>
    ...
    <div class="page-container">
        <header class="main-header">
            <div class="header-left">
                ...
                <button class="mobile-sidebar-toggle" id="mobileSidebarToggle" aria-label="Toggle Mobile Sidebar"><i
                        class="fas fa-bars"></i></button>
            ...
            @else
                <a href="/login" class="header-action-btn custom-btn-text">Login</a>
