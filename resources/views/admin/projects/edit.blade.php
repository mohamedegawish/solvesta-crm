<x-layout title="Edit Contact : {{ $contact->first_name }} {{ $contact->last_name }}">
    ...
    <div class="w-full mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        <form id="contact-form" action="/contacts/{{ $contact->id }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div id="page1" class="grid grid-cols-1 md:grid-cols-2 gap-6">                
                ...
                <div>
                    ...
                    <input type="text" id="first_name" value="{{ old('first_name', $contact->first_name ) }}" name="first_name"
                ...
                <div>
                    ...
                    <input type="text" id="company_id" name="company" value="{{ old('company', $contact->company ) }}"
                ...
                <div>
                    ...
                    <input type="email" id="email-2" name="email_2" value="{{ old('email_2', $contact->email_2) }}"
                ...
                <div>
                    ...
                    <input type="tel" id="phone-2" name="phone_2" value="{{ old('phone_2', $contact->phone_2) }}"
                ...
                <div>
                    ...
                    <input type="tel" id="mobile" name="mobile" value="{{ old('mobile', $contact->mobile) }}"
                ...
                <div>
                    ...
                    <input type="tel" id="fax" name="fax" value="{{ old('fax', $contact->fax) }}"
                ...
                <div>
                    ...
                    <input type="text" id="assistant_name" name="assistant_name" value="{{ old('assistant_name', $contact->assistant_name) }}"
                ...
                <div>
                    ...
                    <input type="tel" id="assistant_phone" name="assistant_phone" value="{{ old('assistant_phone', $contact->assistant_phone) }}"
                ...
                <div>
                    ...
                    <input type="text" id="Skype_ID" name="Skype_ID" value="{{ old('Skype_ID', $contact->Skype_ID) }}"
                ...
                <div>
                    ...
                    <input type="text" id="twitter" name="twitter" value="{{ old('twitter', $contact->twitter) }}"
                ...
                <div>
                    ...
                    <input type="date" id="birth_date" name="birth_date" value="{{ old('birth_date', $contact->birth_date) }}"
            ...
            <div id="page2" class="grid grid-cols-1 md:grid-cols-2 gap-6 hidden">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="mailing_street" name="mailing_street" value="{{ old('mailing_street', $contact->mailing_street) }}"
                        class="bg-gray-50 border {{ $errors->has('mailing_street')? 'border-red-300' :'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <!-- Mailing City -->
                <div>
                    <label for="mailing_city"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mailing City</label>
                    <input type="text" id="mailing_city" name="mailing_city" value="{{ old('mailing_city', $contact->mailing_city) }}"
                        class="bg-gray-50 border {{ $errors->has('mailing_city')? 'border-red-300' :'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <!-- Mailing State -->
                <div>
                    <label for="mailing_state"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mailing State</label>
                    <input type="text" id="mailing_state" name="mailing_state" value="{{ old('mailing_state', $contact->mailing_state) }}"
                        class="bg-gray-50 border {{ $errors->has('mailing_state')? 'border-red-300' :'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <!-- Mailing Zip Code -->
                <div>
                    <label for="mailing_zip_code"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mailing Zip Code</label>
                    <input type="text" id="mailing_zip_code" name="mailing_zip_code" value="{{ old('mailing_zip_code', $contact->mailing_zip_code) }}"
                        class="bg-gray-50 border {{ $errors->has('mailing_zip_code')? 'border-red-300' :'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <!-- Mailing Country -->
                <div>
                    <label for="mailing_country"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mailing Country</label>
                    <input type="text" id="mailing_country" name="mailing_country" value="{{ old('mailing_country', $contact->mailing_country) }}"
                        class="bg-gray-50 border {{ $errors->has('mailing_country')? 'border-red-300' :'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="other_street" name="other_street" value="{{ old('other_street', $contact->other_street) }}"
                        class="bg-gray-50 border {{ $errors->has('other_street')? 'border-red-300' :'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <!-- Other City -->
                <div>
                    <label for="other_city" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Other City</label>
                    <input type="text" id="other_city" name="other_city" value="{{ old('other_city', $contact->other_city) }}"
                        class="bg-gray-50 border {{ $errors->has('other_city')? 'border-red-300' :'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <!-- Other State -->
                <div>
                    <label for="other_state" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Other State</label>
                    <input type="text" id="other_state" name="other_state" value="{{ old('other_state', $contact->other_state) }}"
                        class="bg-gray-50 border {{ $errors->has('other_state')? 'border-red-300' :'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <!-- Other Zip Code -->
                <div>
                    <label for="other_zip_code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Other Zip Code</label>
                    <input type="text" id="other_zip_code" name="other_zip_code" value="{{ old('other_zip_code', $contact->other_zip_code) }}"
                        class="bg-gray-50 border {{ $errors->has('other_zip_code')? 'border-red-300' :'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <!-- Other Country -->
                <div>
                    <label for="other_country"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Other Country</label>
                    <input type="text" id="other_country" name="other_country" value="{{ old('other_country', $contact->other_country) }}"
                        class="bg-gray-50 border {{ $errors->has('other_country')? 'border-red-300' :'border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="4"
                        ...
                        placeholder="Add any additional notes here...">{{ old('description', $contact->description) }}</textarea>
                </div>
